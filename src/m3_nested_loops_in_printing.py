...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and Nathaniel Nate Neil Nordquist.
...
def run_test_triangle_of_stars():
    ...
    print()
    print('-------------------------------------------')
    print('Testing the   TRIANGLE_OF_STARS   function: (upwards pointing)')
    print('-------------------------------------------')
...
def run_test_decreasing_exclamation_marks():
    ...
    print("     (the above should have been blank)")
...
def decreasing_exclamation_marks(m, n):
    ...
    for k in range(m - n  + 1):
        for j in range(m - k):
            print('!', end='')
        print()
    # alternative, less intuitive
    # for k in range(n):
    #     for j in range(m - k):
    #         print('!', end='')
    #     print()
    # The banned string multiplication:
